...
config = config()
name = 'MC2018_Autumn18_monoHiggs_29Mar2020'
...
#listOfSamples = ['TTTo2L2Nu_powheg', 'TTToSemiLeptonic_powheg', 'TTToHadronic_powheg', 'WJetsToLNu', 'W1JetsToLNu', 'W2JetsToLNu', 'W3JetsToLNu', 'W4JetsToLNu', 'DYJetsToLL_M10to50', 'DYJetsToLL', 'DY1JetsToLL', 'DY2JetsToLL', 'DY3JetsToLL', 'DY4JetsToLL', 'WWToLNuQQ', 'VVTo2L2Nu', 'WZTo3LNu', 'WWTo1L1Nu2Q', 'ZZTo4L', 'ZZTo2L2Q', 'ST_tW_top', 'ST_tW_antitop', 'ST_t-channel_top', 'ST_t-channel_antitop', 'GluGluHToTauTau', 'VBFHToTauTau', 'WplusHToTauTau', 'WminusHToTauTau', 'ZHToTauTau', 'EWKZ2Jets_ZToLL', 'EWKZ2Jets_ZToNuNu', 'EWKWPlus2Jets_WToLNu', 'EWKWMinus2Jets_WToLNu', 'GluGluHToWWTo2L2Nu', 'VBFHToWWTo2L2Nu', 'HWplusJ_HToWW', 'HWminusJ_HToWW', 'HZJ_HToWW', 'GluGluZH_HToWW', 'ttHToNonbb', 'WGToLNuG', 'ggZH_HToTauTau_ZToQQ', 'ggZH_HToTauTau_ZToLL', 'ggZH_HToTauTau_ZToNuNu', 'ZJetsToNuNu_HT100-200', 'ZJetsToNuNu_HT200-400', 'ZJetsToNuNu_HT400-600', 'ZJetsToNuNu_HT600-800', 'ZJetsToNuNu_HT800-1200', 'ZJetsToNuNu_HT1200-2500', 'ZJetsToNuNu_HT2500-Inf', 'WWW', 'WWZ', 'WZZ', 'ZZZ']
#listOfSamples = ['DYJetsToLL', 'DY1JetsToLL', 'TTToSemiLeptonic_powheg', 'TTToHadronic_powheg', 'ggZH_HToTauTau_ZToQQ']
#listOfSamples = ['ST_t-channel_top']
#listOfSamples = ['ZJetsToNuNu_HT400-600' ]
listOfSamples = ['DYJetsToLL', 'DY1JetsToLL',  'EWKZ2Jets_ZToLL', 'GluGluHToWWTo2L2Nu', 'VVTo2L2Nu', 'WminusHToTauTau', 'WWToLNuQQ', 'ZJetsToNuNu_HT100-200', 'ZJetsToNuNu_HT2500-Inf', 'ZJetsToNuNu_HT400-600','ZJetsToNuNu_HT600-800',  'ggZH_HToTauTau_ZToQQ']

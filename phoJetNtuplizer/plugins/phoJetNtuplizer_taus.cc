...
vector<float>  tau_byVLooseDeepTau2017v2p1VSjet_;
vector<float>  tau_byLooseDeepTau2017v2p1VSjet_;
vector<float>  tau_byMediumDeepTau2017v2p1VSjet_;
vector<float>  tau_byTightDeepTau2017v2p1VSjet_;
vector<float>  tau_byVTightDeepTau2017v2p1VSjet_;
vector<float>  tau_byVVTightDeepTau2017v2p1VSjet_;

vector<float>  tau_byVVVLooseDeepTau2017v2p1VSe_;
vector<float>  tau_byVVLooseDeepTau2017v2p1VSe_;
vector<float>  tau_byVLooseDeepTau2017v2p1VSe_;
vector<float>  tau_byLooseDeepTau2017v2p1VSe_;
vector<float>  tau_byMediumDeepTau2017v2p1VSe_;
vector<float>  tau_byTightDeepTau2017v2p1VSe_;
vector<float>  tau_byVTightDeepTau2017v2p1VSe_;
vector<float>  tau_byVVTightDeepTau2017v2p1VSe_;

//vector<float>  tau_byVVVLooseDeepTau2017v2p1VSmu_;
//vector<float>  tau_byVVLooseDeepTau2017v2p1VSmu_;
vector<float>  tau_byVLooseDeepTau2017v2p1VSmu_;
...
//  tree->Branch("tau_LeadChargedHadronExists",                           &tau_LeadChargedHadronExists_);
  ...
  tree->Branch("tau_byVLooseDeepTau2017v2p1VSjet",      &tau_byVLooseDeepTau2017v2p1VSjet_);  
  tree->Branch("tau_byLooseDeepTau2017v2p1VSjet",       &tau_byLooseDeepTau2017v2p1VSjet_);  
  tree->Branch("tau_byMediumDeepTau2017v2p1VSjet",      &tau_byMediumDeepTau2017v2p1VSjet_);  
  tree->Branch("tau_byTightDeepTau2017v2p1VSjet",       &tau_byTightDeepTau2017v2p1VSjet_);  
  tree->Branch("tau_byVTightDeepTau2017v2p1VSjet",      &tau_byVTightDeepTau2017v2p1VSjet_);  
  tree->Branch("tau_byVVTightDeepTau2017v2p1VSjet",     &tau_byVVTightDeepTau2017v2p1VSjet_);  

  tree->Branch("tau_byVVVLooseDeepTau2017v2p1VSe",    &tau_byVVVLooseDeepTau2017v2p1VSe_);
  tree->Branch("tau_byVVLooseDeepTau2017v2p1VSe",     &tau_byVVLooseDeepTau2017v2p1VSe_);  
  tree->Branch("tau_byVLooseDeepTau2017v2p1VSe",      &tau_byVLooseDeepTau2017v2p1VSe_);  
  tree->Branch("tau_byLooseDeepTau2017v2p1VSe",       &tau_byLooseDeepTau2017v2p1VSe_);  
  tree->Branch("tau_byMediumDeepTau2017v2p1VSe",      &tau_byMediumDeepTau2017v2p1VSe_);  
  tree->Branch("tau_byTightDeepTau2017v2p1VSe",       &tau_byTightDeepTau2017v2p1VSe_);  
  tree->Branch("tau_byVTightDeepTau2017v2p1VSe",      &tau_byVTightDeepTau2017v2p1VSe_);  
  tree->Branch("tau_byVVTightDeepTau2017v2p1VSe",     &tau_byVVTightDeepTau2017v2p1VSe_);  

  //tree->Branch("tau_byVVVLooseDeepTau2017v2p1VSmu",    &tau_byVVVLooseDeepTau2017v2p1VSmu_);
  //tree->Branch("tau_byVVLooseDeepTau2017v2p1VSmu",     &tau_byVVLooseDeepTau2017v2p1VSmu_);  
  tree->Branch("tau_byVLooseDeepTau2017v2p1VSmu",      &tau_byVLooseDeepTau2017v2p1VSmu_);  
...
void phoJetNtuplizer::fillTaus (const edm::Event& iEvent){
  ...
  for(vector<pat::Tau>::const_iterator itau = tauHandle->begin(); itau != tauHandle->end(); ++itau) {
    ...
    tau_byVLooseDeepTau2017v2p1VSjet_                     .push_back(itau->tauID("byVLooseDeepTau2017v2p1VSjet"));
    tau_byLooseDeepTau2017v2p1VSjet_                      .push_back(itau->tauID("byLooseDeepTau2017v2p1VSjet"));
    tau_byMediumDeepTau2017v2p1VSjet_                     .push_back(itau->tauID("byMediumDeepTau2017v2p1VSjet"));
    tau_byTightDeepTau2017v2p1VSjet_                      .push_back(itau->tauID("byTightDeepTau2017v2p1VSjet"));
    tau_byVTightDeepTau2017v2p1VSjet_                     .push_back(itau->tauID("byVTightDeepTau2017v2p1VSjet"));
    tau_byVVTightDeepTau2017v2p1VSjet_                    .push_back(itau->tauID("byVVTightDeepTau2017v2p1VSjet"));
    
    tau_byVVVLooseDeepTau2017v2p1VSe_                     .push_back(itau->tauID("byVVVLooseDeepTau2017v2p1VSe"));
    tau_byVVLooseDeepTau2017v2p1VSe_                      .push_back(itau->tauID("byVVLooseDeepTau2017v2p1VSe"));
    tau_byVLooseDeepTau2017v2p1VSe_                       .push_back(itau->tauID("byVLooseDeepTau2017v2p1VSe"));
    tau_byLooseDeepTau2017v2p1VSe_                        .push_back(itau->tauID("byLooseDeepTau2017v2p1VSe"));
    tau_byMediumDeepTau2017v2p1VSe_                       .push_back(itau->tauID("byMediumDeepTau2017v2p1VSe"));
    tau_byTightDeepTau2017v2p1VSe_                        .push_back(itau->tauID("byTightDeepTau2017v2p1VSe"));
    tau_byVTightDeepTau2017v2p1VSe_                       .push_back(itau->tauID("byVTightDeepTau2017v2p1VSe"));
    tau_byVVTightDeepTau2017v2p1VSe_                      .push_back(itau->tauID("byVVTightDeepTau2017v2p1VSe"));
    
    //tau_byVVVLooseDeepTau2017v2p1VSmu_                    .push_back(itau->tauID("byVVVLooseDeepTau2017v2p1VSmu"));
    //tau_byVVLooseDeepTau2017v2p1VSmu_                     .push_back(itau->tauID("byVVLooseDeepTau2017v2p1VSmu"));
    tau_byVLooseDeepTau2017v2p1VSmu_                      .push_back(itau->tauID("byVLooseDeepTau2017v2p1VSmu"));
...
void phoJetNtuplizer::initTaus(){
  ...
  tau_byVLooseDeepTau2017v2p1VSjet_                     .clear();
  tau_byLooseDeepTau2017v2p1VSjet_                      .clear();
  tau_byMediumDeepTau2017v2p1VSjet_                     .clear();
  tau_byTightDeepTau2017v2p1VSjet_                      .clear();
  tau_byVTightDeepTau2017v2p1VSjet_                     .clear();
  tau_byVVTightDeepTau2017v2p1VSjet_                    .clear();

  tau_byVVVLooseDeepTau2017v2p1VSe_                     .clear();
  tau_byVVLooseDeepTau2017v2p1VSe_                      .clear();
  tau_byVLooseDeepTau2017v2p1VSe_                       .clear();
  tau_byLooseDeepTau2017v2p1VSe_                        .clear();
  tau_byMediumDeepTau2017v2p1VSe_                       .clear();
  tau_byTightDeepTau2017v2p1VSe_                        .clear();
  tau_byVTightDeepTau2017v2p1VSe_                       .clear();
  tau_byVVTightDeepTau2017v2p1VSe_                      .clear();

  //tau_byVVVLooseDeepTau2017v2p1VSmu_                    .clear();
  //tau_byVVLooseDeepTau2017v2p1VSmu_                     .clear();
  tau_byVLooseDeepTau2017v2p1VSmu_                      .clear();
